...
test('gettReportIds', async () => expect(getFriendReports()).resolves.toBe(mockReportIds));
...
test('getReportInfo', async () => expect(getReport()).resolves.toBe(mockReport));
...
test('getPfp', async () => expect(getPfp()).resolves.toBe(mockPfp));
