...
export async function getReportData(reportId) {
  ...
  let response = await fetch(`http://localhost:5002/Reports/${reportId}/getReportData`, {
    method: 'GET',
    headers: { 'Content-type': 'application/json' },
    mode: 'cors',
    cache: 'Default',
...
export async function sendComment(reportId, newComment) {
  const response = await fetch(`http://localhost:5002/Reports/${reportId}/sendComment`, {
    method: 'PUT',
    headers: { 'Content-Type': 'application/json' },
    mode: 'cors',
    cache: 'default',
...
export async function updateLikes(reportId, userId) {
  const result = await fetch(`http://localhost:5002/Reports/${reportId}/updateLikes`, {
    method: 'PUT',
    headers: { 'Content-Type': 'application/json' },
    mode: 'cors',
    cache: 'default',
